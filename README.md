...
![Режим настройки - выбор порта](docs/images/setting_mode.png)

![Режим настройки - подключение](docs/images/setting_mode2.png)
...
![Инструкция по Telegram](docs/images/tele.png)

### Настройка параметров устройства

Для изменения параметров устройства нужно нажать кнопку «Настройка параметров устройства»:

![Окно настройки параметров](docs/images/setting_mode3.png)

### Результат настройки

После введения параметров они выведутся в окне отладки:

![Вывод результатов настройки](docs/images/setting_mode4.png)

А устройство должно перезагрузиться с новыми параметрами:

![Перезагрузка с новыми параметрами](docs/images/reboot.png)
...
![Работа устройства - Telegram](docs/images/work.png)

![Работа устройства - дисплей](docs/images/work2.png)
...
![Потеря соединения](docs/images/reboot2.png)
